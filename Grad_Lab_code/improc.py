...
img=cv2.imread('Grad_Python\\cat.jpg') #imports as BGR, NOT RGB!; set filepath to your own
...
cat=Image.open('Grad_Python\\cat.jpg') #load images in RGB
...
dog=Image.open('Grad_Python\\dog.jpg')
